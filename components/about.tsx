...
const timeline = [
  { year: "2020", event: "NovaTech.AI Founded", description: "Started with a vision to revolutionize AI" },
  { year: "2021", event: "First AI Product Launch", description: "Released our flagship AI platform" },
  { year: "2022", event: "Robotics Division", description: "Expanded into industrial robotics" },
  { year: "2023", event: "Global Expansion", description: "Opened offices in 5 countries" },
  { year: "2024", event: "100+ Enterprise Clients", description: "Trusted by Fortune 500 companies" },
]
