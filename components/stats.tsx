...
const stats = [
  {
    ...
    description: "Successful AI & automation deployments",
  ...
  },
  {
    ...
    description: "Custom machine learning models deployed",
  ...
  },
  {
    ...
    suffix: "+",
    label: "Technologies",
    description: "Cutting-edge tech stack mastered",
...
function StatCard({ stat, index, isInView }: { stat: typeof stats[0]; index: number; isInView: boolean }) {
  ...
  return (
    ...
    >
      <div className={`glass-card rounded-2xl p-8 h-full text-center transition-all duration-300 ${
        ...
        <div className="relative mb-6 inline-block">
          <div className={`inline-flex p-4 rounded-2xl bg-gradient-to-br ${stat.color}`}>
        ...
        {/* Bottom accent line */}
        <div className={`absolute bottom-0 left-6 right-6 h-1 bg-gradient-to-r ${stat.color} rounded-full scale-x-0 group-hover:scale-x-100 transition-transform duration-500`} />
      </div>
    </motion.div>
  )
}
      ...
      <div ref={ref} className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-6">
            <span className="gradient-text">Numbers That Speak</span>
          </h2>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Our track record of delivering exceptional AI and automation solutions
          </p>
        </motion.div>
